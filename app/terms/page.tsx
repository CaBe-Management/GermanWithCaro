  ...
  return (
    <div className="min-h-screen bg-[#0f0e17]">
      <div className="max-w-2xl mx-auto px-5 py-12">
        ...
        <h1 className="text-3xl font-bold text-[#e8e6f0] mb-2">Terms of Use</h1>
        <p className="text-[#9b98b0] text-sm mb-10">Last updated: April 2026</p>

        <div className="space-y-8 text-[#9b98b0] leading-relaxed">

          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">1. About the app</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">2. Your account</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">3. Acceptable use</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">4. Content</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">5. Availability</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">6. Disclaimer of warranties</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">7. Limitation of liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">8. Governing law</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">9. Changes to these terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">10. Contact</h2>
            <p>
              For questions about these terms, please contact us using the details in the{' '}
              <Link href="/impressum" className="text-[#7c6df2] hover:text-[#9b8cf5] transition-colors">
                Impressum
              </Link>.
            </p>
          </section>
