  ...
  return (
    <div className="min-h-screen bg-[#0f0e17]">
      <div className="max-w-2xl mx-auto px-5 py-12">
        ...
        <h1 className="text-3xl font-bold text-[#e8e6f0] mb-2">Cookie Policy</h1>
        <p className="text-[#9b98b0] text-sm mb-10">Last updated: April 2026</p>

        <div className="space-y-8 text-[#9b98b0] leading-relaxed">

          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">What are cookies?</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">Cookies we use</h2>
            <p className="mb-4">
              German With Caro uses <strong className="text-[#e8e6f0]">essential cookies only</strong>. These are
            ...
            <div className="rounded-xl border border-white/8 overflow-hidden text-sm">
              <div className="grid grid-cols-3 px-4 py-2.5 bg-white/4 text-[#e8e6f0] font-semibold text-xs uppercase tracking-wider">
                <span>Cookie</span>
                <span>Provider</span>
                <span>Purpose</span>
              </div>
              {[
                ...
                <div key={name} className="grid grid-cols-3 px-4 py-3 border-t border-white/5 items-start gap-2">
                  <span className="font-mono text-[#9b8cf5] text-xs break-all">{name}</span>
                  <span>{provider}</span>
            ...
            <p className="mt-4 text-sm">
              These cookies are set by <strong className="text-[#e8e6f0]">Supabase</strong>, our authentication
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">What we do NOT use</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">Do I need to consent?</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#e8e6f0] mb-3">Managing cookies in your browser</h2>
            <p>
